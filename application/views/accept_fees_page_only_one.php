...
<fieldset>
    ...
    ?>
    <form action="<?php echo base_url(); ?>studentController/select_one_student_for_fees" method="post">
        <?php
 ...
 <?php if(isset($month)){ ?>
       ...
       <form action="<?php echo base_url();?>studentController/add_student_fee" method="POST" enctype="">
           <table style="margin-top: 20px; margin-bottom: 30px;" align="center">
                 <tr>
                     <td>Select Month</td>
                     <td><select name="month" >
                             <option value="">--:Select Month:--</option>
                             <option value="01">Jan Month</option>
                             <option value="02">Fab Month</option>
                             <option value="03">Mar Month</option>
                             <option value="04">Apr Month</option>
                             <option value="05">May Month</option>
                             <option value="06">Jun Month</option>
                             <option value="07">July Month</option>
                             <option value="08">Aug Month</option>
                             <option value="09">Sept Month</option>
                             <option value="10">Oct Month</option>
                             <option value="11">Nov Month</option>
                             <option value="12">Dec Month</option>
                             
                         </select></td>
                         <td>
                             <input type="hidden"  name="class_name" value="<?php echo $class_name; ?>">
                             <input type="hidden"  name="stduent_id" value="<?php echo $stduent_id; ?>">
                             <input type="hidden"  name="fee" value="<?php echo $fee->month_fee; ?>">
  ...
  <div id="txtHint2"> 
    ...
    <?php
    foreach ($month as $sInfo){
    ?>
    <tr>
        <td><?php echo $sInfo->student_id_fee ; ?></td>
 ...
 $class=$sInfo->fclass;
         ...
         <td><?php echo $sInfo->month;; ?></td>
         <td><?php echo $sInfo->fee_momth_status ;; ?></td>
