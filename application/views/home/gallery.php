...
<style type="text/css">
    ...
    .album_option{
        border:2px solid #661346; background-color:#661346;
        text-align: right;
        color: white;
    }
    .edit_field{
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-6" style="padding: 3px;">
...
<!--            <form action="#" method="post">
        ...
        <!--</div>-->
         <div class="panel-heading" style="background-color: #661346; color: white; border-bottom: 1px #CCC solid; ">
                        <h3 class="panel-title"><?php echo $album_data->album_name; ?></h3>
                    </div>
   
       <div class="panel-body">
       <a href="<?php echo base_url(); ?>home/gallery_view/<?php echo $album_data->album_id; ?>">
...
//                if (is_array($album_data->album_id)) {
                if(array_key_exists($album_data->album_id, $photo)){
                    foreach ($photo[$album_data->album_id] as $photo_data) {
                        ?>
                <img src="<?php echo base_url() . $photo_data->photo_name; ?>" alt="<?php echo $photo_data->photo_id; ?>" class="img-thumbnail" style="width: 150px; height: 150px">
                        <?php
                    }
                }
//                }
